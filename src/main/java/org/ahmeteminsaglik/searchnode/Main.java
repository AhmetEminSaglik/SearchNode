...
import org.ahmeteminsaglik.searchnode.fakedata.FakeDataCreation;
import org.ahmeteminsaglik.searchnode.testing.TestingArrayList;
import org.ahmeteminsaglik.searchnode.testing.TestingSearchNode;
import org.ahmeteminsaglik.searchnode.testing.TimeCalculation;
...
public class Main {
    ...
    public static void main(String[] args) {
        SearchNode<String> demoSearchNode= new SearchNode<>();
        demoSearchNode.add("demoSearchNode1");
        demoSearchNode.add("demoSearchNode2");
        demoSearchNode.add("demoSearchNode3");
        demoSearchNode.add("demo1");
        demoSearchNode.add("demo2");
        demoSearchNode.add("demo3");
        demoSearchNode.add("demo3");
        demoSearchNode.add("demo4");
        System.out.println(demoSearchNode.search("demo3").getData());
        System.exit(0);
